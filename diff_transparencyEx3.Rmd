...
img_animated_f <- image_animate(img_joined, fps = 2)

## view animated image
img_animated_f

## save to disk
image_write(image = img_animated_f,
            path = "truefield.gif")
...
## animate at 2 frames per second
img_animated_pm <- image_animate(img_joined, fps = 2)

## view animated image
img_animated_pm

## save to disk
image_write(image = img_animated_pm,
            path = "posmean.gif")

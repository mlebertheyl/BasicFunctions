General function for spatial fields with plots.
...
```{r}
plot.transparency <- function(nfrac = 1,
                              left.poly = 0.1,
                              poly.bar.orginal = poly.bar.orginal,
                              fps = 1,
                              pal.field = plasma(50),
                              pal.pos.mean = plasma(50),
                              pal.pos.sd = plasma(50),
                              pal.pos.q25 = plasma(50),
                              pal.pos.q50 = plasma(50),
                              pal.pos.q975 = plasma(50),
                              
                              pal.pos.mean.st = plasma(50),
                              pal.pos.sd.st = plasma(50),
                              pal.pos.q25.st = plasma(50),
                              pal.pos.q50.st = plasma(50),
                              pal.pos.q975.st = plasma(50),
                              ...
    ){
  ...
  for (r in 1:nfrac) {
    ...
    image_write(image = image_animate(
      ...
      fps = fps), 
      path = ("gif/gif.fx/true.field.gif"))
    ...
    image_write(image = image_animate(
      ...
      fps = fps), 
      path = ("gif/gif.fx/stat.rnadom.mean.gif"))
    ...
    image_write(image = image_animate(
      ...
      fps = fps), 
      path = ("gif/gif.fx/pos.q25.st.gif"))
    ...
    image_write(image = image_animate(
      ...
      fps = fps), 
      path = ("gif/gif.fx/pos.q975.st.gif"))
}
```
